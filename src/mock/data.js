...
export const aboutData = {
  img: "profile.jpg",
  paragraphOne:
    "I am a Full Stack Web Developer With 6 months of developing experience. I have recently graduated from UCF Coding Boot Camp (02/21) where I am skilled in both Front-end and Back-end. Additionally, I have a background in customer service and sales. Overall, I am open-minded with problem solving, communication, and leadership skills when working in teams. I am always looking for ways to improve and pride myself on taking on challenges that can only strengthen my craft. I look forward to helping to discover and provide the best possible results when given a task while keeping my full level of integrity intact.",
  paragraphTwo: "",
  paragraphThree: "",
  resume:
    "https://docs.google.com/document/d/1xDfFe2n_ji6Zi2M_pN0HsGi-f8b_Aq3q/edit?usp=sharing&ouid=111498724899685056145&rtpof=true&sd=true", // if no resume, the button will not show up
  certificate:
